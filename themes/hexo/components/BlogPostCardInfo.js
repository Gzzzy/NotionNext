       ...
       <div>
         ...
         <Link
            ...
            className={`replace cursor-pointer hover:underline text-2xl ${showPreview ? 'text-center' : ''
                } leading-tight text-gray-600 dark:text-gray-100 hover:text-green-600 dark:hover:text-green-500`}>
        ...
        <div
            className={`flex mt-2 items-center ${showPreview ? 'justify-center' : 'justify-start'
                } flex-wrap dark:text-gray-500 text-gray-400 hover:text-green-600 dark:hover:text-green-500`}
        >
            <Link
       ...
       <div>
         ...
         <div className="text-gray-400 justify-between flex">
            <Link
                ...
                passHref
                className="cursor-pointer font-light text-sm hover:underline hover:text-green-600 dark:hover:text-green-500 transform">
