        ...
        <div className="text-center space-y-3">
          ...
          <div className="flex mx-4">
            <input
              ...
              className="outline-none w-full text-sm pl-5 rounded-l transition focus:shadow-lg dark:text-gray-300 font-light leading-10 text-black bg-gray-0 dark:bg-gray-300"
            ></input>
            <div
