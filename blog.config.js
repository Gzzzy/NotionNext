...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '562d4fcc4b4546d0b67010e0115f8f70',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Gzzzy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '江湖艺人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.gzzzy.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'anderson.gzy@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/gzzzy', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/gzzzy', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  BACKGROUND_DARK: '#3c3c3c', // use hex value, don't forget '#'
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.gzzzy.top', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || 'f46b4575-83da-4b6c-b0a1-f1babae5d9b5', // data-app-id 36位 see https://cusdis.com/
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Gzzzy\'s BLOG', // 站点标题 ，被notion中的页面标题覆盖
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '未佩妥剑，出门便已是江湖', // 站点描述，被notion中的页面描述覆盖
